...
export const alt = 'VectorShip AI Solutions — AI, Software & Automation'
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, position: 'relative' }}>
          <div
            style={{
              width: 40,
              height: 40,
              border: '2px solid #65e2e0',
              transform: 'rotate(45deg)',
              display: 'flex',
            }}
          />
          <span style={{ fontSize: 32, fontWeight: 700, color: '#f4f7fb', letterSpacing: '-0.02em' }}>VectorShip</span>
        </div>
        <div
          style={{
            display: 'flex',
